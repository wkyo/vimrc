...
" set bomb
au FileType python setlocal fo=tcroqjmB
au FileType javascript,html,css,vim,python,yaml,markdown,stylus setlocal softtabstop=2 tabstop=2 shiftwidth=2 expandtab
